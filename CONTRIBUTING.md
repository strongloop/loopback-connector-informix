...
Thank you for your interest in `loopback-connector-informix`, an open source project
administered by StrongLoop (an IBM Company).

Contributing to `loopback-connector-informix` is easy. In a few simple steps:
  ...
  * Sign the [Contributor License Agreement](https://cla.strongloop.com/agreements/strongloop/loopback-connector-informix)
